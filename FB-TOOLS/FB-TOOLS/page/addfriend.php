...
<br>
                <div class="col-lg-5" style="float:none;"><button id="start_friend" onclick="addfriend();" class="btn btn-success btn-block"><i class="fa fa-user-plus"></i> เริ่มปั้มเพื่อน</button></div>
